...
try {
    ...
    if ($usuario && isset($usuario["productos"])) {
        echo json_encode(["success" => true, "productos" => $usuario["productos"]]);
    } else {
        echo json_encode(["success" => true, "productos" => []]); // Devuelve un array vacío si no hay productos
    }
} catch (Exception $e) {
